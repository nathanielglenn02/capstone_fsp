...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Okt 2024 pada 02.14
...
(31, 1, 'The Nice', '2004-02-10', 'Donat'),
(32, 1, 'Champion League', '2024-10-06', 'Today is'),
(33, 1, 'The Cocok Moment', '2024-10-07', 'Always'),
(34, 1, 'In Ma', '2024-10-01', 'Tipas');
...
--
ALTER TABLE `achievement`
  MODIFY `idachievement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
