...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Okt 2024 pada 20.45
...
(13, 13, 'Speed Demon', '2024-09-20', 'Won the Speed Demons race.'),
...
(1, 1, 'Kings of Battle'),
(2, 2, 'Champions United'),
(3, 3, 'Elite Snipers'),
(4, 4, 'Glory Racers'),
(5, 5, 'Strike Squad'),
(6, 6, 'Legends of Combat'),
(7, 7, 'Soccer Stars FC'),
(8, 8, 'Rocket Racers Club'),
(9, 9, 'Battlefield Warriors'),
(10, 10, 'Frenzy Fighters'),
(11, 11, 'Cyber Attackers'),
(12, 12, 'Warzone Tactical'),
(13, 13, 'Demon Racers'),
(14, 14, 'Heroes United'),
(15, 15, 'Basketball Blitzers'),
(16, 16, 'Ultimate Fight Club'),
(17, 17, 'Fantasy Warriors'),
(18, 18, 'Golf Rivals Club'),
(19, 19, 'Space Raiders Guild'),
(20, 20, 'Dodgeball Aces'),
(21, 21, 'Zombie Slayers'),
(22, 22, 'Tank Warriors'),
(23, 23, 'Epic Racers'),
(24, 24, 'Volleyball Smashers'),
(25, 25, 'Hill Defenders'),
(26, 26, 'Ninja Showdown Crew'),
(27, 27, 'Pirate Buccaneers'),
(28, 28, 'Drone Pilots League'),
(29, 29, 'MOBA Masters'),
(30, 30, 'Flag Capturers');
...
--
ALTER TABLE `achievement`
  MODIFY `idachievement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `join_proposal`
  MODIFY `idjoin_proposal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `member`
--
ALTER TABLE `member`
  MODIFY `idmember` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT untuk tabel `team`
--
ALTER TABLE `team`
  MODIFY `idteam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
